export default function InfoPage() {
  return (
    <main className="min-h-screen bg-ink text-paper px-6 py-16 md:px-12 max-w-2xl mx-auto">
      ...
      <div className="font-mono text-sm text-signal uppercase tracking-wide mt-8 mb-8">Info</div>
      ...
      <div className="font-mono text-sm text-signal uppercase tracking-wide mt-12 mb-4">Currently Learning</div>
