...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-ink text-paper px-6 py-16 md:px-12 max-w-xl mx-auto">
      ...
      <div className="font-mono text-sm text-signal mt-8 mb-8"># contact</div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-panel border border-white/10 rounded px-3 py-2 text-paper focus:outline-none focus:border-signal"
            />
          </div>
          <div>
          ...
          <button
            ...
            className="font-mono text-sm px-4 py-2 rounded bg-signal text-ink font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
          >
