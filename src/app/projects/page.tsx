...
export default async function ProjectsPage() {
  ...
  return (
    <main className="min-h-screen bg-ink text-paper px-6 py-16 md:px-12">
      ...
      <div className="font-mono text-sm text-signal mt-8 mb-8"># all projects</div>
      {projects.length === 0 ? (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project) => (
            <Link
              ...
              className="bg-panel rounded-lg p-6 border border-white/5 hover:border-signal/40 transition-colors block"
            >
